...
ActiveRecord::Schema.define(version: 20_220_204_204_044) do
  ...
  create_table 'badges', force: :cascade do |t|
    ...
    t.string 'criteria_value', null: false
    t.bigint 'creator_id', null: false
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index ['creator_id'], name: 'index_badges_on_creator_id'
    t.index %w[criteria criteria_value], name: 'index_badges_on_criteria_and_criteria_value', unique: true
  end
